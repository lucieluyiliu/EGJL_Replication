...
# Keep link with most recent company name to the cusip
...
# 2.2 CRSP: Get all permno-exchange ticker combinations
...
#keep last date for each permno-ticker combination
...
with open('Data/iclink.pkl', 'wb') as f:
    pkl.dump(iclink, f)